...
def Stratergy_one(Stock_name,Supertrend_period,Supertrend_length,EMA_1,EMA_2,SMA):
    ...
    for i, row in data.iterrows():
        if i<5:
            ...
            #print(data.loc[i-2,'ST_BUY_SELL'])
            data.loc[i,"BUY_SELL"]="SELL"  
        elif (data.loc[i-3,'ST_BUY_SELL']=='SELL') & (data.loc[i-2,'ST_BUY_SELL']=='SELL') & (data.loc[i-1,'ST_BUY_SELL']=='BUY') & (data.loc[i-4,'MACD_BUY_SELL']=='SELL') & (data.loc[i-3,'MACD_BUY_SELL']=='SELL') & ((data.loc[i-2,'MACD_BUY_SELL']=='BUY') | (data.loc[i-1,'MACD_BUY_SELL']=='BUY')) & ((data.loc[i-4,'VWAP_CO']=='VWAP_SELL') | (data.loc[i-3,'VWAP_CO']=='VWAP_SELL') | (data.loc[i-2,'VWAP_CO']=='VWAP_SELL') & (data.loc[i-1,'VWAP_CO']=='VWAP_BUY')) & (data.loc[i-1,'MACDS']<-macd_alignment(data.loc[i-1,'close'])): # :
            data.loc[i,"BUY_SELL"]="S1_BUY"
        elif (data.loc[i-3,'ST_BUY_SELL']=='BUY') & (data.loc[i-2,'ST_BUY_SELL']=='BUY') & (data.loc[i-1,'ST_BUY_SELL']=='SELL') & (data.loc[i-4,'MACD_BUY_SELL']=='BUY') & (data.loc[i-3,'MACD_BUY_SELL']=='BUY') & ((data.loc[i-2,'MACD_BUY_SELL']=='SELL') | (data.loc[i-1,'MACD_BUY_SELL']=='SELL')) & ((data.loc[i-4,'VWAP_CO']=='VWAP_BUY') | (data.loc[i-3,'VWAP_CO']=='VWAP_BUY') | (data.loc[i-2,'VWAP_CO']=='VWAP_BUY') & (data.loc[i-1,'VWAP_CO']=='VWAP_SELL')) & (data.loc[i-1,'MACDS']>macd_alignment(data.loc[i-1,'close'])): # : 
            #print(data.loc[i-2,'ST_BUY_SELL'])
            data.loc[i,"BUY_SELL"]="S1_SELL" 
        elif (data.loc[i-3,'ST_BUY_SELL']=='SELL') & (data.loc[i-2,'ST_BUY_SELL']=='SELL') & (data.loc[i-1,'ST_BUY_SELL']=='BUY') & (data.loc[i-4,'VWAP_CO']=='VWAP_SELL') & (data.loc[i-3,'VWAP_CO']=='VWAP_SELL') & (data.loc[i-1,'VWAP_CO']=='VWAP_BUY') & (data.loc[i-1,'MACDS']<3):
            data.loc[i,"BUY_SELL"]="S2_BUY"
        elif (data.loc[i-3,'ST_BUY_SELL']=='BUY') & (data.loc[i-2,'ST_BUY_SELL']=='BUY') & (data.loc[i-1,'ST_BUY_SELL']=='SELL') & (data.loc[i-4,'VWAP_CO']=='VWAP_BUY') & (data.loc[i-3,'VWAP_CO']=='VWAP_BUY') & (data.loc[i-1,'VWAP_CO']=='VWAP_SELL') & (data.loc[i-1,'MACDS']>3): # : 
            #print(data.loc[i-2,'ST_BUY_SELL'])
            data.loc[i,"BUY_SELL"]="S2_SELL"
    '''
    if (data.iloc[-2:,9]=="BUY").all() & (data.iloc[-1,16]<-macd_alignment(LTP_PRICE)) & (data.iloc[-1,16]>data.iloc[-3,16]) : 
       #print(data.iloc[-1,0],data.iloc[-1,7],'BUY',LTP_PRICE,macd_alignment(LTP_PRICE),data.iloc[-2,16],data.iloc[-1,16])
        ST_BB=[data.iloc[-1,7],LTP_PRICE,data.iloc[-1,9],data.iloc[-1,8],data.iloc[-1,10],data.iloc[-1,11],data.iloc[-1,12],data.iloc[-1,13],data.iloc[-1,14],"BUY",data.iloc[-2,15],data.iloc[-2,16],data.iloc[-2,17]]
    elif (data.iloc[-2:,9]=="SELL").all() & (data.iloc[-1,16]>macd_alignment(LTP_PRICE)) & (data.iloc[-1,16]<data.iloc[-3,16]) : 
        print(data.iloc[-1,0],data.iloc[-1,7],'SELL',LTP_PRICE,macd_alignment(LTP_PRICE),data.iloc[-2,16],data.iloc[-1,16])
        ST_BB=[data.iloc[-1,7],LTP_PRICE,data.iloc[-1,9],data.iloc[-1,8],data.iloc[-1,10],data.iloc[-1,11],data.iloc[-1,12],data.iloc[-1,13],data.iloc[-1,14],"SELL",data.iloc[-2,15],data.iloc[-2,16],data.iloc[-2,17]]
    else:
        ST_BB=[data.iloc[-1,7],LTP_PRICE,"NA",data.iloc[-1,8],data.iloc[-1,10],data.iloc[-1,11],data.iloc[-1,12],data.iloc[-1,13],data.iloc[-1,14],"NA",data.iloc[-2,15],data.iloc[-2,16],data.iloc[-2,17]]
    ...
    if (data.iloc[-2:,9]=="BUY").all() & (data.iloc[-5:-2,9]=="SELL").all() & (data.iloc[-1,10]>data.iloc[-1,11]) & (data.iloc[-1,12]<data.iloc[-1,10])& (data.iloc[-1,12]<data.iloc[-1,11]) & (data.iloc[-1,13]=="INC"): 
        ...
        ST_BB=[data.iloc[-1,7],LTP_PRICE,"NA",data.iloc[-1,8],data.iloc[-1,10],data.iloc[-1,11],data.iloc[-1,12],data.iloc[-1,13],data.iloc[-1,14],"NA",data.iloc[-2,15],data.iloc[-2,16],data.iloc[-2,17]]
    '''
    if (data.iloc[-1:,9]=="BUY").all() & (data.iloc[-5:-2,9]=="SELL").all() &  (data.iloc[-1:,16]=="BUY").all() & (data.iloc[-5:-2,16]=="SELL").all() & (data.iloc[-1:,19]=="BUY").all() & (data.iloc[-5:-2,19]=="SELL").any():
        ST_BB=[str(data.iloc[-1,0]),data.iloc[-1,7],LTP_PRICE,"BUY"]
    elif (data.iloc[-1:,9]=="SELL").all() & (data.iloc[-5:-2,9]=="BUY").all() &  (data.iloc[-1:,16]=="SELL").all() & (data.iloc[-5:-2,16]=="BUY").all() & (data.iloc[-1:,19]=="SELL").all() & (data.iloc[-5:-2,19]=="BUY").any():
        ST_BB=[str(data.iloc[-1,0]),data.iloc[-1,7],LTP_PRICE,"SELL"]
    else:
        ST_BB=[str(data.iloc[-1,0]),data.iloc[-1,7],LTP_PRICE,"NA"]
    #print(ST_BB)
    Result=pd.DataFrame(ST_BB).transpose()
    Result.columns=["Datetime","SYMBOL","LTP","BUY_SELL"]
    Result=Result.astype({"LTP":float,"BUY_SELL":str})
    return(Result,data)
...
def run():    
    ...
    for i, row in ns_stock_token.iterrows():
        ...
        output=Stratergy_one(value,48,3,20,50,100)
        data=output[1]
        data2=output[0]
        #print(data)
        #break
        if ((data['BUY_SELL']=='BUY').any() & (data['Datetime']>=start_date).any()) | ((data['BUY_SELL']=='SELL').any() & (data['Datetime']>=start_date).any()) :
            ...
            if len(result)>0:
                for j, row in result.iterrows():
                    ...
                    for k in msg_rep:
                        if k.__contains__('On '+str(result.loc[j,'Datetime'])+' '+result.loc[j,'BUY_SELL']+' '+str(result.loc[j,'Symbol'])):
                            #print(k, msg)
                            pass
                        elif 'On '+str(result.loc[j,'Datetime'])+' '+result.loc[j,'BUY_SELL']+' '+str(result.loc[j,'Symbol'])+ ' at ' not in msg_rep:
                            print(msg)
                            twlio (msg,'+919944333650')
                            twlio (msg,'+919092005708')
                            msg_rep.append('On '+str(result.loc[j,'Datetime'])+' '+result.loc[j,'BUY_SELL']+' '+str(result.loc[j,'Symbol'])+ ' at ')
        if ((data['BUY_SELL']=='S1_BUY').any() & (data['Datetime']>=start_date).any()) | ((data['BUY_SELL']=='S1_SELL').any() & (data['Datetime']>=start_date).any()) :
            ...
            if len(result)>0:
                for j, row in result.iterrows():
                    ...
                    for k in msg_rep:
                        if k.__contains__('STRATERGY S1 On '+str(result.loc[j,'Datetime'])+' '+result.loc[j,'BUY_SELL']+' '+str(result.loc[j,'Symbol'])):
                            pass
                        elif 'STRATERGY S1 On '+str(result.loc[j,'Datetime'])+' '+result.loc[j,'BUY_SELL']+' '+str(result.loc[j,'Symbol'])+ ' at ' not in msg_rep:
                            print(msg)
                            #twlio (msg,'+919944333650')
                            #twlio (msg,'+919092005708')
                            msg_rep.append('STRATERGY S1 On '+str(result.loc[j,'Datetime'])+' '+result.loc[j,'BUY_SELL']+' '+str(result.loc[j,'Symbol'])+ ' at ')
                #print(msg)
        if ((data['BUY_SELL']=='S2_BUY').any() & (data['Datetime']>=start_date).any()) | ((data['BUY_SELL']=='S2_SELL').any() & (data['Datetime']>=start_date).any()) :
            ...
            if len(result)>0:
                for j, row in result.iterrows():
                    ...
                    for k in msg_rep:
                        if k.__contains__('STRATERGY S2 On '+str(result.loc[j,'Datetime'])+' '+result.loc[j,'BUY_SELL']+' '+str(result.loc[j,'Symbol'])):
                            pass
                        elif 'STRATERGY S2 On '+str(result.loc[j,'Datetime'])+' '+result.loc[j,'BUY_SELL']+' '+str(result.loc[j,'Symbol'])+ ' at ' not in msg_rep:
                            print(msg)
                            #twlio (msg,'+919944333650')
                            #twlio (msg,'+919092005708')
                            msg_rep.append('STRATERGY S2 On '+str(result.loc[j,'Datetime'])+' '+result.loc[j,'BUY_SELL']+' '+str(result.loc[j,'Symbol'])+ ' at ')
                #print(msg)
    ...
    #except:
    #    pass
#print(datetime.now().replace(hour=00,minute=00,second=00,microsecond=00))


# FGHB541D3V95Z2X25YYEZ7N1 /ACcdbe3073da3cca3db9474335567928ee / ae94facd386899c76d148d35635b834e
#fall-trunk


#twlio("HI, test msg initated from Twilio by Bibeesh",'+919944333650')
#twlio("HI, test msg initated from Twilio by Bibeesh",'+919092005708')

run()

#for i in msg_rep:
#    if i.__contains__('On 2024-07-02 11:40:00+05:30 SELL ADANIPORTS'):
#        print(i)
